...
class Seq2SeqDataset(AbstractSeq2SeqDataset):
    ...
    def mask_batch(self, batch_encoding, mlm_probability=0.15):
        # batch_encodings: Dict, batch_encodings['input_ids']: torch.Tensor
    ...
    def collate_fn(self, batch) -> Dict[str, torch.Tensor]:
        ...
        batch_encoding = self.mask_batch(batch_encoding)
